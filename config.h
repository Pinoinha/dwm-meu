...
static const char col_cyan[]        = "#5c16ab";
...
static const char *xscreensvr[] = { "xscreensaver-command", "-lock", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_l,      spawn,          {.v  = xscreensvr } }, // Tranca a tela com xscreensaver
};
